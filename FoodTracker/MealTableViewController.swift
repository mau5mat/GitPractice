...
class MealTableViewController: UITableViewController {
  ...
  override func viewDidLoad() {
    ...
    //Loads any saved meals, otherwise loads sample data.
  ...
  private func saveMeals() {
    ...
    if isSuccessfulSave {
      os_log("Meals were saved successfully saved.", log: OSLog.default, type: .debug)
    } else {
      os_log("Failed to save data.", log: OSLog.default, type: .debug)
    }
  }
